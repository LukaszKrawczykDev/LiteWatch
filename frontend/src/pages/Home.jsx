...
export default function Home() {
    ...
    const [liteTop, setLiteTop] = useState([]);
    const [loading, setLoading] = useState(true);

    useEffect(() => {
        const fetchAll = async () => {
            const base = import.meta.env.VITE_API_URL;
            const [p, t, u, l] = await Promise.all([
    ...
    return (
        <>
            ...
            <div className="space-y-12">
                ...
                <MovieRow title="Najlepiej oceniane na LiteWatch" movies={liteTop} />
                <MovieRow title="Najpopularniejsze (TMDB)" movies={topRated} />
